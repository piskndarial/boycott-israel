...
const Empty = ({})  => {
    ...
    return(
        <div className='flex items-center justify-center p-10 text-center flex-col space-y-4'>
            ...
            <Link 
                href="mailto:piskndar@gmail.com?subject=Boycott Suggestion&body=Company Name:%0D%0ACompany Website:%0D%0AAlternative Options:%0D%0AReason for Boycott:%0D%0AProof URL:" 
